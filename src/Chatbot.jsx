  ...
  return (
    <>
        <div className="w-full h-full flex items-center justify-center">
          ...
          {!messages.length && (
            <div className="top-[200px] left-1/2 transform -translate-x-1/2 max-w-[500px]">
              <h1 className="font-black text-white text-4xl">ChatGPT</h1>
              <p className="text-white mt-2">
                Hello there! I'm ChatGPT, a language model trained to assist you
                with various topics and questions. What can I help you with
                today? Feel free to type your query or topic of interest, and
                I'll do my best to provide you with helpful and informative
                responses.
              </p>
            </div>
          )}
